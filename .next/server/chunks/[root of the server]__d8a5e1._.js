...
async function POST(req) {
    try {
        ...
        // Generate HMAC
        const generatedHmac = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac('sha256', SECRET_KEY).update(shop).digest('hex');
        // Compare HMAC
        if (generatedHmac !== hmac) {
            console.error("HMAC mismatch in verify-shop:", {
                generatedHmac,
                hmac
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d8a5e1._.js.map