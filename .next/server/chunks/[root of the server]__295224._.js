...
const shopify = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shopify$2f$shopify$2d$api$2f$dist$2f$esm$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["shopifyApi"])({
    apiKey: ("TURBOPACK compile-time value", "741afd8614d725cc23d10832395e8513"),
    apiSecretKey: ("TURBOPACK compile-time value", "7f1835f140d127809e7e22649d81ef26"),
    ...
    hostName: ("TURBOPACK compile-time value", "https://95f1-223-185-56-236.ngrok-free.app").replace(/^https?:\/\//, ""),
    hostScheme: "https",
    isEmbeddedApp: false
});
...
;
;
const express = __turbopack_require__("[externals]/express [external] (express, cjs)");
const cors = __turbopack_require__("[project]/node_modules/cors/lib/index.js [app-route] (ecmascript)");
const app = express();
app.use(cors()); // Enable CORS for Next.js requests
const MONGO_URI = process.env.MONGO_URI;
const SECRET_KEY = ("TURBOPACK compile-time value", "7f1835f140d127809e7e22649d81ef26");
...
async function GET(req, res) {
    ...
    try {
        ...
        const hostWithoutProtocol = ("TURBOPACK compile-time value", "https://95f1-223-185-56-236.ngrok-free.app").replace(/^https?:\/\//, "");
...
app.listen(3000, ()=>{
    console.log("Server is running on port 5000 haa bhai kya huaa");
}); // // src/app/api/auth/callback/route.js
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__295224._.js.map