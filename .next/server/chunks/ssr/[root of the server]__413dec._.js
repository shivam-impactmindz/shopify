...
"[project]/src/app/components/Header.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
//   const [redirectUrl, setRedirectUrl] = useState("");
//   useEffect(() => {
//     fetch("/api/products/link") // ✅ Use relative path
//       .then((res) => {
//         if (!res.ok) throw new Error(`HTTP error! Status: ${res.status}`);
//         return res.json();
//       })
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__413dec._.js.map